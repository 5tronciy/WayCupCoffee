...
public class Coupons extends AppCompatActivity  implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_menu:
                Intent intent = new Intent(Coupons.this, MenuActivity.class);
                startActivity(intent);
                this.overridePendingTransition(0, 0);
                break;
            case R.id.ibtn_waycup_header:
                Intent intent2 = new Intent(Coupons.this, AboutActivity.class);
                startActivity(intent2);
                this.overridePendingTransition(0, 0);
                break;
            case R.id.ibtn_card_footer:
                Intent intent3 = new Intent(Coupons.this, UserCard.class);
                startActivity(intent3);
                this.overridePendingTransition(0, 0);
                break;
            case R.id.ibtn_home_footer:
                Intent intent4 = new Intent(Coupons.this, MainActivity.class);
                startActivity(intent4);
                this.overridePendingTransition(0, 0);
                break;
            case R.id.ibtn_coupons_footer:
                Intent intent5 = new Intent(Coupons.this, Coupons.class);
                startActivity(intent5);
                this.overridePendingTransition(0, 0);
                break;
            case R.id.ibtn_contact_footer:
                Intent intent6 = new Intent(Coupons.this, Contacts.class);
